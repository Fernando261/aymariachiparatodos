...
import { ChevronRightIcon, HeartIcon } from "@/components/AppIcons";
...
const CONTENT = {"title": "Favoritos", "subtitle": "Tus mariachis, serenatas y servicios guardados aparecerán aquí."};
        ...
        <View style={styles.appFrame}>
          ...
          <View style={styles.content}>
            <View style={styles.iconCard}>
              <HeartIcon size={42} color={COLORS.gold} strokeWidth={1.8} />
            </View>
