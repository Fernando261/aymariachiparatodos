...
export default function Screen() {
  return <MariachiScreenShell title="Ganancias" subtitle="Flujo del mariachi" activeTab="Ganancias"><View style={styles.tempCard}><Text style={styles.tempTitle}>Pantalla temporal premium</Text><Text style={styles.tempText}>Aquí construiremos el módulo de ganancias para proveedores mariachi.</Text></View></MariachiScreenShell>;
}
