...
import { ChevronRightIcon, UserIcon } from "@/components/AppIcons";
...
const CONTENT = {"title": "Perfil", "subtitle": "Gestiona tu información, preferencias y datos de contratación."};
        ...
        <View style={styles.appFrame}>
          ...
          <View style={styles.content}>
            <View style={styles.iconCard}>
              <UserIcon size={42} color={COLORS.gold} strokeWidth={1.8} />
            </View>
