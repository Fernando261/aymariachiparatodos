...
import { ChevronRightIcon, CalendarIcon } from "@/components/AppIcons";
...
const CONTENT = {"title": "Mis eventos", "subtitle": "Administra tus próximas celebraciones y contrataciones con estilo."};
        ...
        <View style={styles.appFrame}>
          ...
          <View style={styles.content}>
            <View style={styles.iconCard}>
              <CalendarIcon size={42} color={COLORS.gold} strokeWidth={1.8} />
            </View>
