...
export default function Screen() {
  return <MariachiScreenShell title="Agenda" subtitle="Flujo del mariachi" activeTab="Agenda"><View style={styles.tempCard}><Text style={styles.tempTitle}>Pantalla temporal premium</Text><Text style={styles.tempText}>Aquí construiremos el módulo de agenda para proveedores mariachi.</Text></View></MariachiScreenShell>;
}
