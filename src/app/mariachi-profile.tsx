...
export default function Screen() {
  return <MariachiScreenShell title="Perfil" subtitle="Flujo del mariachi" activeTab="Perfil"><View style={styles.tempCard}><Text style={styles.tempTitle}>Pantalla temporal premium</Text><Text style={styles.tempText}>Aquí construiremos el módulo de perfil para proveedores mariachi.</Text></View></MariachiScreenShell>;
}
