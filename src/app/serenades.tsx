...
import { ChevronRightIcon, SparklesIcon } from "@/components/AppIcons";
...
const CONTENT = {"title": "Serenatas", "subtitle": "Sorprende a esa persona especial con una experiencia musical íntima y elegante."};
        ...
        <View style={styles.appFrame}>
          ...
          <View style={styles.content}>
            <View style={styles.iconCard}>
              <SparklesIcon size={42} color={COLORS.gold} strokeWidth={1.8} />
            </View>
